...
public class CarController {
    ...
    @GetMapping("/last-added-id")
    public ResponseEntity<Integer> getLastAddedCarId() {
        int lastAddedCarId = carService.getLastAddedCarId();
        return ResponseEntity.ok(lastAddedCarId);
    }
